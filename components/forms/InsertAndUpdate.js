...
const InsertAndUpdate = ({ title, value, ocultar, setOcultar,setValue, handleCancel, handleInsert, handleUpdate, constForm, options }) => {
  ...
  return (
      <div style={{ marginBottom: '150px', marginTop: '20px', height: `180px` }}>
        <h3>{title}</h3>
        ...
        { 
            ...
            <div className="col-md-12">
              ...
              {
                value.id > 0 ? <Stack direction="row" spacing={2} style={{ float: 'right', fontSize: '12px' }} >
                  ...
                  : <Button variant="contained" style={{ float: 'right', fontSize: '12px' }} size="large" type='submit'>
                    Agregar
                  </Button>
              }
            </div>
